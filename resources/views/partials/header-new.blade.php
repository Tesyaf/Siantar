<header class="bg-white/95 backdrop-blur-md border-b border-gray-100 sticky top-0 z-50 shadow-sm">
  <div class="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 py-3 text-[14px]">
    ...
    <button id="mobile-menu-btn" class="md:hidden p-2 rounded-lg hover:bg-orange-50 text-gray-600 hover:text-orange-500 transition-colors flex-shrink-0">
...
<div id="mobile-overlay" class="hidden fixed inset-0 bg-black/50 z-[9998] md:hidden"></div>

<!-- Mobile Slide Menu - OUTSIDE header -->
<div id="mobile-menu" class="fixed top-0 right-0 h-full w-72 max-w-[85vw] bg-white shadow-2xl z-[9999] overflow-y-auto transform translate-x-full transition-transform duration-300 ease-in-out md:hidden">
  
  <!-- Mobile Menu Header -->
  <div class="flex items-center justify-between p-4 border-b border-gray-100">
    <span class="font-bold text-gray-900">Menu</span>
    <button id="close-menu-btn" class="p-2 rounded-lg hover:bg-gray-100 text-gray-600">
