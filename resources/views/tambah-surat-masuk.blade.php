...
<main class="container py-4">
    ...
    <h1 class="mt-2 mb-1 text-3xl font-extrabold text-gray-900">Tambah Surat Masuk</h1>
    <p class="text-gray-500 mb-4">Gunakan formulir berikut untuk mencatat surat masuk ke dalam sistem.</p>
    ...
    <section class="bg-white border border-gray-200 rounded-3 shadow-sm p-3 p-lg-4">
      ...
      <div class="row g-3">
        <div class="col-lg-6">
          <div class="fw-bold text-gray-700 small mb-2">Nomor Surat <span class="text-danger">*</span></div>
          <input class="form-control" name="letter_number" value="{{ old('letter_number') }}" placeholder="Masukkan nomor surat" required />
        </div>
        <div class="col-lg-6">
          <div class="fw-bold text-gray-700 small mb-2">Pengirim <span class="text-danger">*</span></div>
          <input class="form-control" name="sender" value="{{ old('sender') }}" placeholder="Nama instansi/organisasi pengirim" required />
        </div>
        ...
        <div class="col-lg-6">
          <div class="fw-bold text-gray-700 small mb-2">Tanggal Diterima <span class="text-danger">*</span></div>
          <div class="input-group">
            <input class="form-control" type="date" name="received_date" value="{{ old('received_date') }}" required />
            <span class="input-group-text"><i class="bi bi-calendar3"></i></span>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          ...
          <input class="form-control" value="Surat Masuk" readonly />
        </div>
        <div class="col-lg-6">
        ...
        <div class="col-12">
          ...
          <textarea class="form-control" name="summary" rows="4" placeholder="Ringkasan singkat isi surat...">{{ old('summary') }}</textarea>
        ...
        <div class="col-12 mt-2">
          <div class="fw-bold text-gray-700 small mb-1">Data Tambahan</div>
          <div class="text-muted small">Kolom opsional digunakan jika data tersedia, dapat dikosongkan bila tidak ada.</div>
        </div>

        <div class="col-lg-6">
          <div class="fw-bold text-gray-700 small mb-2">Nomor Berkas <span class="text-muted">(Opsional)</span></div>
          <input class="form-control" name="index_code" value="{{ old('index_code') }}" placeholder="Masukkan nomor berkas" />
        </div>
        <div class="col-lg-6">
          <div class="fw-bold text-gray-700 small mb-2">Dari Surat Masuk - Tanggal <span class="text-muted">(Opsional)</span></div>
          <div class="input-group">
            <input class="form-control" type="date" name="reference_letter_date" value="{{ old('reference_letter_date') }}" />
            <span class="input-group-text"><i class="bi bi-calendar3"></i></span>
          </div>
        </div>

        <div class="col-lg-6">
          <div class="fw-bold text-gray-700 small mb-2">Dari Surat Masuk - Nomor <span class="text-muted">(Opsional)</span></div>
          <input class="form-control" name="reference_letter_number" value="{{ old('reference_letter_number') }}" placeholder="Masukkan nomor surat referensi" />
        </div>
        <div class="col-lg-6">
          <div class="fw-bold text-gray-700 small mb-2">Nomor Petunjuk <span class="text-muted">(Opsional)</span></div>
          <input class="form-control" name="instruction_number" value="{{ old('instruction_number') }}" placeholder="Masukkan nomor petunjuk" />
        </div>

        <div class="col-lg-6">
          <div class="fw-bold text-gray-700 small mb-2">Nomor Paket <span class="text-muted">(Opsional)</span></div>
          <input class="form-control" name="package_number" value="{{ old('package_number') }}" placeholder="Masukkan nomor paket" />
        </div>
      </div>
    </section>
    ...
    <section class="bg-white border border-gray-200 rounded-3 shadow-sm p-3 p-lg-4 mt-3">
      ...
      <div class="position-relative border border-2 border-dashed border-gray-300 rounded-3 p-4 text-center bg-white transition" data-upload>
        <input type="file" id="lampiran-file-masuk" name="file" class="visually-hidden" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx" data-upload-input />
        <div class="d-flex flex-column align-items-center gap-2">
          ...
          <div class="d-flex justify-content-center gap-2">
            <label class="btn btn-light btn-sm border border-gray-200 fw-bold" for="lampiran-file-masuk">
    ...
    <div class="d-flex justify-content-end gap-2 mt-3">
      <a class="btn btn-outline-secondary fw-bold" href="{{ route('surat-masuk.index') }}">Batal</a>
